...
export default {
  props:{
    introInfo:{
      ...
      default: ()=> ({
        name:'尚德教育',
        intro: '嗨学网致力成为世界一流的互联网教育服务提供商，是中国首家兼具学术研发基因与互联网基因的职业教育培训领先品牌，是目前国内最专业的新锐派远程教育平台。嗨学网的培训课程和服务范围广阔，从职业资格考试的学习培训、技能培训，到与执业相关的就业服务，用户遍及全国各地。目前，嗨学网标准化的课程体系，已成为职业培训在线教育领域的模板。',
